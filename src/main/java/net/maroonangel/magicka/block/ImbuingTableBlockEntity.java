...
public class ImbuingTableBlockEntity extends BlockEntity implements Nameable, Tickable {
    ...
    public ImbuingTableBlockEntity() {
        super(Blocks.IMBUING_TABLE_BLOCK_ENTITY);
    }
    ...
    public Text getName() {
        return (Text)(this.customName != null ? this.customName : new TranslatableText("container.magicka.imbue"));
    }
